...
namespace CG.Blazor.Forms.Attributes
{
    ...
    /// the form generator to render the property as a number HTML element.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of decorating a model property to render a number:
    /// <code>
    ...
    public class RenderInputNumberAttribute : HtmlAttribute
    {
        // *******************************************************************
        // Properties.
        // *******************************************************************
        ...
        /// <summary>
        /// This constructor creates a new instance of <see cref="RenderInputNumberAttribute"/>
        /// class.
        /// </summary>
        public RenderInputNumberAttribute()
        {
            // Set default values.
            AutoFocus = false;
            Label = string.Empty;
            ...
            )
        {
            ...
            try
            {
                // If we get here then we are trying to render a number HTML element
                ...
                if (path.Count < 2)
                {
                    ...
                    logger.LogDebug(
                        "RenderInputNumberAttribute::Generate called with a shallow path!"
                        );
                ...
                if (null == model)
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "RenderInputNumberAttribute::Generate called with a null model!"
                        );
                ...
                // We only render number controls against numeric types.
                    ...
                    modelType == typeof(decimal))
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "Rendering property: '{PropName}' as a number element.",
                        prop.Name
                        );
                ...
                else
                {
                    ...
                    logger.LogDebug(
                        ...
                        "because we only render number elements on properties " +
            ...
            catch (Exception ex)
            {
                ...
                throw new FormGenerationException(
                    message: "Failed to render an number element! " +
