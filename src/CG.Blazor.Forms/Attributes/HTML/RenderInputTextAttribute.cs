...
namespace CG.Blazor.Forms.Attributes
{
    ...
    /// the form generator to render the property as an input HTML element.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of decorating a model property to render an input:
    /// <code>
    ...
    public class RenderInputTextAttribute : HtmlAttribute
    {
        // *******************************************************************
        // Properties.
        // *******************************************************************
        ...
        /// <summary>
        /// This constructor creates a new instance of <see cref="RenderInputTextAttribute"/>
        /// class.
        /// </summary>
        public RenderInputTextAttribute()
        {
            // Set default values.
            AutoFocus = false;
        ...
        public override IDictionary<string, object> ToAttributes()
        {
            ...
            {
                // Add the property value.
                attr[nameof(SpellCheck)] = SpellCheck;
            }
            ...
            )
        {
            ...
            try
            {
                // If we get here then we are trying to render an input HTML element
                ...
                if (path.Count < 2)
                {
                    ...
                    logger.LogDebug(
                        "RenderInputTextAttribute::Generate called with a shallow path!"
                        );
                ...
                if (null == model)
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "RenderInputTextAttribute::Generate called with a null model!"
                        );
                ...
                // We only render text controls against strings.
                if (modelType == typeof(string))
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "Rendering property: '{PropName}' as an input element.",
                        prop.Name
                        );
                ...
                else
                {
                    ...
                    logger.LogDebug(
                        ...
                        "because we only render input elements on properties " +
