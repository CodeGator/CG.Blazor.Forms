...
namespace CG.Blazor.Forms.Attributes
{
    ...
    /// causes the form generator to render the property as a meter HTML element.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of decorating a model property to render a meter:
    /// <code>
    ...
    public class RenderMeterAttribute : HtmlAttribute
    {
        // *******************************************************************
        // Properties.
        // *******************************************************************
        ...
        /// <summary>
        /// This constructor creates a new instance of <see cref="RenderMeterAttribute"/>
        /// class.
        /// </summary>
        public RenderMeterAttribute()
        {
            // Set default values.
            Label = string.Empty;
            Low = string.Empty;
            ...
            )
        {
            ...
            try
            {
                // If we get here then we are trying to render a meter HTML element
                ...
                if (path.Count < 2)
                {
                    ...
                    logger.LogDebug(
                        "RenderMeterAttribute::Generate called with a shallow path!"
                        );
                ...
                if (null == model)
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "RenderMeterAttribute::Generate called with a null model!"
                        );
                ...
                // We only render meter controls against numeric types.
                    ...
                    modelType == typeof(decimal))
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "Rendering property: '{PropName}' as a meter element.",
                        prop.Name
                        );
                ...
                else
                {
                    ...
                    logger.LogDebug(
                        ...
                        "because we only render meter elements on properties " +
            ...
            catch (Exception ex)
            {
                ...
                throw new FormGenerationException(
                    message: "Failed to render a meter element! " +
