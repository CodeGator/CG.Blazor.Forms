...
{
    /// <summary>
    /// This class is an attribute that, when applied to a string property, 
    /// causes the form generator to render the property as an URL HTML 
    /// element.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of decorating a model property to render a URL:
    /// <code>
    ...
    public class RenderInputUrlAttribute : HtmlAttribute
    {
        // *******************************************************************
        // Properties.
        // *******************************************************************
        ...
        /// <summary>
        /// This constructor creates a new instance of <see cref="RenderInputUrlAttribute"/>
        /// class.
        /// </summary>
        public RenderInputUrlAttribute()
        {
            // Set default values.
            ...
            )
        {
            ...
            try
            {
                // If we get here then we are trying to render a URL HTML element
                ...
                if (path.Count < 2)
                {
                    ...
                    logger.LogDebug(
                        "RenderInputUrlAttribute::Generate called with a shallow path!"
                        );
                ...
                if (null == model)
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "RenderInputUrlAttribute::Generate called with a null model!"
                        );
                ...
                // We only render url controls against strings.
                if (modelType == typeof(string))
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "Rendering property: '{PropName}' as a URL element.",
                        prop.Name
                        );
            ...
            catch (Exception ex)
            {
                ...
                throw new FormGenerationException(
                    message: "Failed to render an URL element! " +
