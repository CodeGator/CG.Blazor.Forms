...
namespace CG.Blazor.Forms.Attributes
{
    ...
    /// the form generator to render the property as a textarea HTML element.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// </remarks>
    /// <example>
    /// Here is an example of decorating a model property to render a textarea:
    /// <code>
    ...
    public class RenderTextAreaAttribute : HtmlAttribute
    {
        // *******************************************************************
        // Properties.
        // *******************************************************************
        ...
        /// <summary>
        /// This property indicates the number of characters to show, on the 
        /// component.
        /// </summary>
        ...
        /// <summary>
        /// This property indicates the number of rows to show, on the component.
        /// </summary>
        ...
        /// <summary>
        /// This constructor creates a new instance of the <see cref="RenderTextAreaAttribute"/>
        /// class.
        /// </summary>
        public RenderTextAreaAttribute()
        {
            // Set default values.
            AutoFocus = false;
            Cols = 1;
            ...
            )
        {
            ...
            try
            {
                // If we get here then we are trying to render a textarea HTML element
                ...
                if (path.Count < 2)
                {
                    ...
                    logger.LogDebug(
                        "RenderTextAreaAttribute::Generate called with a shallow path!"
                        );
                ...
                if (null == model)
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "RenderTextAreaAttribute::Generate called with a null model!"
                        );
                ...
                // We only render TextArea controls against strings.
                if (prop.PropertyType == typeof(string))
                {
                    // Let the world know what we're doing.
                    logger.LogDebug(
                        "rendering property: '{PropName}' as a textarea element.",
                        prop.Name
                        );
                ...
                else
                {
                    ...
                    logger.LogDebug(
                        ...
                        "because we only render textarea elements on properties " +
            ...
            catch (Exception ex)
            {
                ...
                throw new FormGenerationException(
                    message: "Failed to render an TextArea element! " +
